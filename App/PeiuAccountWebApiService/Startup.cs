    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<AccountEF>(
                options => options.UseMySql(DataAccessor.DataAccessorBase.CreateConnectionString("peiu_account")));
            ...
            services.AddSingleton<MysqlDataContext>();
...
//#endif
        ...
        private void ConfigureAuthrozation(IServiceCollection services)
        {
            services.AddAuthorization(options =>
            {
                ...
                options.AddPolicy(UserPolicyTypes.AccountManager,
                   policy => policy.RequireRole(UserRoleTypes.Supervisor, UserRoleTypes.AccountManager));
                options.AddPolicy(UserPolicyTypes.HubbubManager,
                    policy => policy.RequireRole(UserRoleTypes.Supervisor, UserRoleTypes.HubbubUser));
            });
