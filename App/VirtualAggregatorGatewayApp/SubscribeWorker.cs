...
namespace PeiuPlatform
{
    ...
    public abstract class SubscribeWorker : BackgroundService
    {
        ...
        public async Task<bool> ConnectionAsync()
        {
            ...
            return await ConnectionAsync(bindAddress, port, 0, Topics);
        }

        public async Task<bool> ConnectionAsync(string bindAddress, ushort port, ushort QoSLevel, params string[] SubscribeTopic)
        {
