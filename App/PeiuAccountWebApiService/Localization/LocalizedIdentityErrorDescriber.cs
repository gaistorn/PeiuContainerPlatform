...
namespace PeiuPlatform.App.Localization
{
    public class LocalizedIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        public IdentityError RegisterFileNotFound()
        {
            return this.GetErrorByCode("RegisterFileNotFound");
        }
        ...
        public IdentityError Expired()
        {
            return this.FormatErrorByCode("Expired");
        }
